    ...
    <div class="container">
      ...
      <div class="nav-scroller py-1 mb-2">
        <nav class="nav d-flex justify-content-between">
          ...
          <a class="p-2 text-muted" href="">Processors</a>
          <a class="p-2 text-muted" href="">Boards</a>
          <a class="p-2 text-muted" href="">Memory</a>
          ...
          <a class="p-2 text-muted" href="">Shopping</a>
        </nav>
      </div>

      <div class="jumbotron p-3 p-md-5 text-white rounded bg-dark starimg">
        <div>
        <div class="col-md-6 px-0">
          ...
          <p class="lead mb-0"><a href="#" class="text-white font-weight-bold">詳細はこちら</a></p>
        </div>
        </div>
      </div>
        ...
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 box-shadow h-md-250">
            <div class="card-body d-flex flex-column align-items-start">
              ...
              <p class="card-text mb-auto">7月7日に販売決定したCopland OSの最新版<br>
              ワイヤードへのリアルタイムレンダリングも最大3kGb/s<sup>※</sup>で全身投影もストレスフリーで実現可能<span class="text-muted">(※ベストエフォート)</span></p>
        ...
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 box-shadow h-md-250">
            <div class="card-body d-flex flex-column align-items-start">
              ...
              <p class="card-text mb-auto">手のひらに収まるサイズのNAVIで、制限付きでワイヤードへの接続機能が付きました。メールなど従来の機能もより快適に！</p>
              <a href="#">製品詳細はこちら</a>
            </div>
      ...
      <div class="row">
        <div class="col-md-8 blog-main">
          ...
          <div class="blog-post">
            ...
            <p class="blog-post-meta">April 16 by <a href="#">英利 政美</a></p>

            <p>3年前に発表されたCopland OSは</p>
          </div><!-- /.blog-post -->
